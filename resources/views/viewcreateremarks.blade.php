                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">View/Update Book Remarks</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                                        ...
                                        <tbody>
                                            ...
                                            <form method="post" action="">
                                                ...
                                                @foreach($createremarks as $createremarks)

                                                <tr class="odd">

                                                <td>{{ $createremarks->id }}</td>
                                                    <td>{{ $createremarks->name }}</td>
                                                    <!-- <td><button type="button" class="btn btn-block btn-success">Edit </button></td> -->

                                                    <td><a href="{{ route('createremarks.edit',  $createremarks->id) }}"
