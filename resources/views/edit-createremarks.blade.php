...
@section('content')
 ...
 <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit Book Remarks</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
      ...
      <form action="{{route('createremarks.update')}}" method="post">
@csrf
      <input type="hidden" name="id" value= "{{ $createremarks->id }}"> 
    <p>Book Remarks: <input type="text" value="{{$createremarks->name}}" name="name" placeholder="Enter Category">
    <button type="submit" class="btn btn-info">Update</button></p>
